...
export type AddAnswerMutationVariables = Exact<{
  answer: Scalars['String']['input'];
  addAnswerId: Scalars['String']['input'];
}>;


export type AddAnswerMutation = { __typename?: 'Mutation', addAnswer: { __typename?: 'Taxonomy', answer?: string | null, id: string, level: number, questionLabel: string, subtopic: string, topic: string } };
...
export type GetQuestionsQuery = { __typename?: 'Query', getQuestions: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null, children?: Array<{ __typename?: 'TaxonomyTree', id: string, level: number, questionLabel: string, subtopic: string, topic: string, answer?: string | null }> | null }> | null }> | null }> | null }> | null }> | null }> };


export const AddAnswerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddAnswer"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"answer"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"addAnswerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addAnswer"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"answer"},"value":{"kind":"Variable","name":{"kind":"Name","value":"answer"}}},{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"addAnswerId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"answer"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"questionLabel"}},{"kind":"Field","name":{"kind":"Name","value":"subtopic"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}}]}}]}}]} as unknown as DocumentNode<AddAnswerMutation, AddAnswerMutationVariables>;
